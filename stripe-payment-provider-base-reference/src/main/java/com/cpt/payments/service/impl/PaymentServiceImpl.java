...
public class PaymentServiceImpl implements PaymentService {
	...
	public StripeProviderResponse initiatePayment(StripeProviderRequest stripeProviderRequest) {
		...
		paymentServiceHelper.saveProviderRequestResponse(stripeProviderRequest.getTransactionReference(), httpRequest, response);
	...
	public Transaction paymentDetails(Transaction transaction) {
		...
		paymentServiceHelper.saveProviderRequestResponse(transaction.getTxnReference(), httpRequest, response);
