...
public class InitiatePaymentRequestHandler {
	...
	//	httpRequest.getHeaders().setBasicAuth(token);
		return httpRequest;
	}
	...
	private Map<String, String> prepareRequestFormPayload(StripeProviderRequest stripeProviderRequest) {
		...
		initiatePaymentRequestPayload.put("mode", "payment");
		...
		initiatePaymentRequestPayload.put("cancel_url", "https://www.bing.com/");
